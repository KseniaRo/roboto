    ...
    return (
      <div >
        <div >
          ...
          {this.props.project.completed === false ? <div><p>Project in the progress</p><button onClick={() => this.completeProject(projectId)} type="button"> Complete this project</button></div> : <p> Project completed</p>}
        </div>
        <h3>Assign Robots:</h3>
